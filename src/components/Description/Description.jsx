  ...
  return (
    <section style={{ position: "relative" }}>
      <div className="row pb-5 ">
        <div className="col pb-5 mb-5"></div>
        <div className="col-8 mb-5">
          <div className="row mb-5">
            ...
            <div className="col-lg-6  pb-5 mb-5">
              <h3 className="text-start display-4">About Me</h3>
              <p className="text-start p-4 border border-dark ">
                ...
                hobbies are playing videogames 🎮 and listening lofi music 🎶
                while creating new development projects 💻.
                <br />
                Nice to meet you!!
              </p>
            </div>
